"""
Django settings for dinnerdashv2 project.
...
SECRET_KEY = 'django-insecure-^$ur%ty&2fia6)koc(9x86#=x#s9u=dfs4-+1t7tv@pq2cn%q3'
...
WSGI_APPLICATION = 'dinnerdashv2.wsgi.application'
